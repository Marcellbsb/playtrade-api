        ...
        <>
            ...
            <Container>
                <p>Sobre o PlayTrade
                    ...
                    No PlayTrade, você faz parte de uma comunidade dedicada a enriquecer suas experiências no mundo dos games. Junte-se a nós e descubra como é fácil e divertido trocar seus jogos, fazer novos amigos e explorar novos títulos. Estamos aqui para tornar cada troca uma oportunidade de conexão e diversão. leooo
                </p>
            </Container>
            <Footer />
        </>
